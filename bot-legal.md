...
* **Sea of Thieves Twitch Drops**#0910 (861319119079997510)
...
The following items will be collected and stored when intentionally provided by a user (by means of a the "/setup" command).
* Guild ID Number
* Channel ID Number
* Role ID Number
